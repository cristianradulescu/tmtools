...
-- Started on 2017-02-10 16:33:05 UTC
...
-- Name: company_id_seq; Type: SEQUENCE; Schema: public; Owner: tmtoolsuser
--
...
-- Name: document; Type: TABLE; Schema: public; Owner: tmtoolsuser
--
...
ALTER TABLE document OWNER TO tmtoolsuser;

--
-- TOC entry 188 (class 1259 OID 16427)
-- Name: document_id_seq; Type: SEQUENCE; Schema: public; Owner: tmtoolsuser
--
...
-- Name: document_status; Type: TABLE; Schema: public; Owner: tmtoolsuser
--
...
ALTER TABLE document_status OWNER TO tmtoolsuser;

--
-- TOC entry 193 (class 1259 OID 16448)
-- Name: document_status_id_seq; Type: SEQUENCE; Schema: public; Owner: tmtoolsuser
--
...
-- Name: document_type; Type: TABLE; Schema: public; Owner: tmtoolsuser
--
...
ALTER TABLE document_type OWNER TO tmtoolsuser;

--
-- TOC entry 195 (class 1259 OID 16482)
-- Name: document_type_id_seq; Type: SEQUENCE; Schema: public; Owner: tmtoolsuser
--
...
CREATE TABLE employee (
  ...
  identity_card_number character varying(9) NOT NULL,
...
-- Name: employee_id_seq; Type: SEQUENCE; Schema: public; Owner: tmtoolsuser
--
...
-- Name: employee_job_title_id_seq; Type: SEQUENCE; Schema: public; Owner: tmtoolsuser
--
...
-- Name: fos_user; Type: TABLE; Schema: public; Owner: tmtoolsuser
--
...
-- Name: fos_user_id_seq; Type: SEQUENCE; Schema: public; Owner: tmtoolsuser
--
...
ALTER TABLE fos_user_id_seq OWNER TO tmtoolsuser;

--
-- TOC entry 198 (class 1259 OID 16531)
-- Name: reimbursement; Type: TABLE; Schema: public; Owner: tmtoolsuser
--
...
ALTER TABLE reimbursement OWNER TO tmtoolsuser;

--
-- TOC entry 197 (class 1259 OID 16529)
-- Name: reimbursement_id_seq; Type: SEQUENCE; Schema: public; Owner: tmtoolsuser
--
...
-- Name: reimbursement_type; Type: TABLE; Schema: public; Owner: tmtoolsuser
--
...
ALTER TABLE reimbursement_type OWNER TO tmtoolsuser;

--
-- TOC entry 199 (class 1259 OID 16538)
-- Name: reimbursement_type_id_seq; Type: SEQUENCE; Schema: public; Owner: tmtoolsuser
--
...
-- Name: travel; Type: TABLE; Schema: public; Owner: tmtoolsuser
--
...
ALTER TABLE travel OWNER TO tmtoolsuser;

--
-- TOC entry 204 (class 1259 OID 16566)
-- Name: travel_destination; Type: TABLE; Schema: public; Owner: tmtoolsuser
--
...
ALTER TABLE travel_destination OWNER TO tmtoolsuser;

--
-- TOC entry 203 (class 1259 OID 16564)
-- Name: travel_destination_id_seq; Type: SEQUENCE; Schema: public; Owner: tmtoolsuser
--
...
-- Name: travel_id_seq; Type: SEQUENCE; Schema: public; Owner: tmtoolsuser
--
...
-- Name: travel_purpose; Type: TABLE; Schema: public; Owner: tmtoolsuser
--
...
ALTER TABLE travel_purpose OWNER TO tmtoolsuser;

--
-- TOC entry 205 (class 1259 OID 16572)
-- Name: travel_purpose_id_seq; Type: SEQUENCE; Schema: public; Owner: tmtoolsuser
--
...
-- Name: document id; Type: DEFAULT; Schema: public; Owner: tmtoolsuser
--
...
-- Name: document_status id; Type: DEFAULT; Schema: public; Owner: tmtoolsuser
--
...
-- Name: document_type id; Type: DEFAULT; Schema: public; Owner: tmtoolsuser
--
...
-- Name: employee id; Type: DEFAULT; Schema: public; Owner: tmtoolsuser
--
...
-- Name: employee_job_title id; Type: DEFAULT; Schema: public; Owner: tmtoolsuser
--
...
-- Name: reimbursement id; Type: DEFAULT; Schema: public; Owner: tmtoolsuser
--
...
-- Name: reimbursement_type id; Type: DEFAULT; Schema: public; Owner: tmtoolsuser
--
...
-- Name: travel id; Type: DEFAULT; Schema: public; Owner: tmtoolsuser
--
...
-- Name: travel_destination id; Type: DEFAULT; Schema: public; Owner: tmtoolsuser
--
...
-- Name: travel_purpose id; Type: DEFAULT; Schema: public; Owner: tmtoolsuser
--
...
INSERT INTO company (id, name, cost_center, division_manager_id) VALUES (2, 'eMAG', '12RO123456', 1);
...
INSERT INTO document (id, type_id, status_id, employee_id) VALUES (1, 1, 1, 1);
INSERT INTO document (id, type_id, status_id, employee_id) VALUES (2, 2, 1, 1);
...
INSERT INTO employee (id, first_name, last_name, username, birthday, personal_numeric_code, identity_card_number, job_title_id, division_manager_id, company_id) VALUES (1, 'Cristian', 'Radulescu', 'cristian.radulescu', '2017-01-29', 1234567890098, 'AB 123456', 1, 1, 2);
...
INSERT INTO fos_user (id, username, username_canonical, email, email_canonical, enabled, salt, password, last_login, confirmation_token, password_requested_at, roles) VALUES (1, 'admin', 'admin', 'admin', 'admin', true, NULL, '$2y$13$Gmh9yX5cYiSWhlxlYhJ6d..Ko7qtyi1nrJBRExBS8rjmsFPwLLCQS', '2017-02-09 13:56:39', NULL, NULL, 'a:1:{i:0;s:10:"ROLE_ADMIN";}');
...
INSERT INTO reimbursement (id, type_id, number, date, value, employee_id, document_id) VALUES (1, 1, '111', '2017-02-08', 65.00, 1, 2);
...
INSERT INTO reimbursement_type (id, name) VALUES (2, 'Fuel receipt');
INSERT INTO reimbursement_type (id, name) VALUES (3, 'Taxi receipt');
INSERT INTO reimbursement_type (id, name) VALUES (4, 'Bill');
INSERT INTO reimbursement_type (id, name) VALUES (5, 'Travel allowance');
...
SELECT pg_catalog.setval('reimbursement_type_id_seq', 5, true);
...
INSERT INTO travel (id, purpose_id, destination_id, employee_id, date_start, date_end, departure_leave_time, destination_arrival_time, destination_leave_time, departure_arrival_time, document_id) VALUES (1, 1, 1, 1, '2017-02-01', '2017-02-03', '2017-02-01 06:00:00', '2017-02-01 09:00:00', '2017-02-03 18:00:00', '2017-02-03 21:30:00', 1);
...
INSERT INTO travel_purpose (id, name) VALUES (2, 'Planning');
INSERT INTO travel_purpose (id, name) VALUES (3, 'Company event');
INSERT INTO travel_purpose (id, name) VALUES (4, 'Presentation');
INSERT INTO travel_purpose (id, name) VALUES (5, 'Course');
...
SELECT pg_catalog.setval('travel_purpose_id_seq', 5, true);
...
-- Name: fos_user fos_user_pkey; Type: CONSTRAINT; Schema: public; Owner: tmtoolsuser
--
...
-- Name: travel_purpose travel_purpose_pkey; Type: CONSTRAINT; Schema: public; Owner: tmtoolsuser
--
...
--
-- TOC entry 2089 (class 1259 OID 24591)
...
-- Name: uniq_957a647992fc23a8; Type: INDEX; Schema: public; Owner: tmtoolsuser
--
...
-- Name: uniq_957a6479a0d96fbf; Type: INDEX; Schema: public; Owner: tmtoolsuser
--
...
-- Name: uniq_957a6479c05fb297; Type: INDEX; Schema: public; Owner: tmtoolsuser
--
...
-- Name: document document_document_status_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: tmtoolsuser
--
...
-- Name: document document_document_type_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: tmtoolsuser
--
...
-- Name: employee employee_company_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: tmtoolsuser
--
...
-- Name: employee employee_division_manager_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: tmtoolsuser
--
...
-- Name: employee employee_job_title_id_fk; Type: FK CONSTRAINT; Schema: public; Owner: tmtoolsuser
--
...
-- Completed on 2017-02-10 16:33:05 UTC
